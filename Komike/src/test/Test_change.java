 ...
 */
@WebServlet("/Test")
public class Test_change extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String[] q13 = request.getParameterValues("Question13");
		String[] q14 = request.getParameterValues("Question14");
		String[] q15 = request.getParameterValues("Question15");
		String[] q16 = request.getParameterValues("Question16");
		String[] q17 = request.getParameterValues("Question17");
		String[] q18 = request.getParameterValues("Question18");
		String[] q19 = request.getParameterValues("Question19");
		String[] q20 = request.getParameterValues("Question20");
